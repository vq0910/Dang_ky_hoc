                    ...
                    <div class="container">
                        <div class="panel panel-primary" style="overflow-x:auto;">
                            ...
                            <div class="panel-body">
                                <a href="add.php">
                                    <button class="btn btn-success" style="margin-bottom: 15px;">Thêm Sinh viên</button>
                                </a>
                                <table class="table table-bordered table-hover table-responsive" >
                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            $sinhvienList = executeResult($sql1);
                                            // $lopList = executeResult($sql2);
                                            $index=1;
                                            foreach($sinhvienList as $item){
                                                echo'<tr>
                                                        <td >'.($index++).'</td>
                                                        <td >'.$item['Hovaten'].'</td>
                                                        <td >'.$item['MSV'].'</td>
                                                        ...
                                                        <td>
                                                            <button class="btn btn-danger" onclick="deletekhoahoc('.$item['id'].')">Xoá</button>
                                                        </td>
                                                    </tr>';
                                            }
                                        ?>
