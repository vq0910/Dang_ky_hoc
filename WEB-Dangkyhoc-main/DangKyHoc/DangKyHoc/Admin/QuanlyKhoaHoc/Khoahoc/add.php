<?php 
    ...
    $MKH= $Tenkhoahoc= $NgayDangKy=$HanDangKy='';
    if (!empty($_POST)) {
        if (isset($_POST['MKH'])) {
            $MKH = $_POST['MKH'];
        }
        ...
        if (!empty($Tenkhoahoc)) {
            //Luu vao database
            if ($MKH == '') {
                $sql1 = 'insert into Khoahoc(Tenkhoahoc,NgayDangKy,HanDangKy) 
                values ("'.$Tenkhoahoc.'","'.$NgayDangKy.'","'.$HanDangKy.'")';
            } 
            else {
                $sql1 = 'update Khoahoc set Tenkhoahoc ="'.$Tenkhoahoc.'",NgayDangKy ="'.$NgayDangKy.'",HanDangKy ="'.$HanDangKy.'" where MKH = '.$MKH;
